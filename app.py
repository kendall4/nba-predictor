...
with tab_nba:
    ...
    # Sub-tabs inside NBA
    tab_leader, tab_predict, tab_hot, tab_sgp, tab_lines, tab_player, tab_games = st.tabs([
        "🏆 Leaderboard", "📈 Predictions", "🔥 Hot Hand", "🎰 Live SGP", "📊 Lines Explorer", "🧑‍💻 Player Explorer", "🗓️ Games"
    ])
